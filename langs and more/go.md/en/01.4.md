...
![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.liteide.png)
...
- Intelligent completion
	...
	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.sublime1.png)
	
	Figure 1.5 Sublime intelligent completion
- Auto-format source files
- Project management

	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.sublime2.png)
...
![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.sublime3.png)
...
2. To install GoSublime, SidebarEnhancements and Go Build, press `Ctrl+Shift+p` to open Package Control, then type `pcip` (short for "Package Control: Install Package").
	...
	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.sublime4.png)
...
![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.vim.png)
...
![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.emacs.png)
...
![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.eclipse1.png)
...
6. Check the installation
	...
	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.eclipse5.png)
	
	Figure 1.15 Create a new project and file
	
	Test installation as follows.(you need to type command in console in Eclipse)
	
	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.eclipse6.png)
...
1. Download IDEA, there is no difference between the Ultimate and Community editions
	...
	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.idea1.png)
	
2. Install the Go plugin. Choose `File - Setting - Plugins`, then click `Browser repo`.

	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.idea3.png)
	
3. Search `golang`, double click `download and install` and wait for the download to complete.

	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.idea4.png)
	
	Click `Apply`, then restart.
4. Now you can create a Go project.

	![](my-obsidian/langs%20and%20more/go.md/en/images/1.4.idea5.png)
...
- Previous section: [Go commands](myBrain/ЯП%20и%20не%20только/go.md/en/01.3.md)
- Next section: [Summary](myBrain/ЯП%20и%20не%20только/go.md/en/01.5.md)
