...
```
![](my-obsidian/langs%20and%20more/go.md/en/images/2.4.student_struct.png)
...
- Previous section: [Control statements and functions](myBrain/ЯП%20и%20не%20только/go.md/en/02.3.md)
- Next section: [Object-oriented](myBrain/ЯП%20и%20не%20только/go.md/en/02.5.md)
