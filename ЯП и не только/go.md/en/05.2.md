...
- Previous section: [database/sql interface](myBrain/ЯП%20и%20не%20только/go.md/en/05.1.md)
- Next section: [SQLite](myBrain/ЯП%20и%20не%20только/go.md/en/05.3.md)
